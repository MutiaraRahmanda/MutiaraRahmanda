...
Route::get('/news', function($p = 'news'){
    echo '<a href = "https://www.educastudio.com/news">' .$p. '</a>';
});
Route::get('/news/{news}', function($p = 'educa-studio-berbagi-untuk-warga-sekitar-terdampak-covid-19'){
    echo '<a href = "https://www.educastudio.com/news/' .$p.'">'.$p. '</a>';
});
